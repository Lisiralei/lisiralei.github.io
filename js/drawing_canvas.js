import { GpuEngine as Engine } from "./gpu_engine.js";
...
export class DrawingCanvas extends HTMLElement {
  ...
  bind(element) {
    ...
    element.attachEvents = element.attachEvents.bind(this);
  ...
  attachEvents() {
    ...
    document.getElementById("gravityButton").addEventListener('click', () => this.toggleGravity());
  }
