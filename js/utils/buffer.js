 ...
 * @param {number} elementStride number of indices per element
 * @returns
 */
 ...
 * @param {{ positions: number, colors: number, indices: boolean, uvs: number, normals: number }} options number of 32-bit elements per vertex
 */
